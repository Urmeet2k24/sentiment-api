...
positives = [
    ...
    "five stars could not be happier",
    ...
    "good experience overall happy",
    "this item is great value",
    "loving this product every day",
    "glad I purchased this item",
    "this works great no issues at all",
    "product is wonderful and useful",
    "I enjoy this product very much",
    "excellent value exceeded expectations",
    "super happy with this delivery",
    "the product is fantastic and well made",
    "really satisfied with this purchase",
    "this is exactly what I needed love it",
    "brilliant quality and great packaging",
    ...
    "amazing product delivered fast great",
    "so impressed with the quality and service",
    ...
    "top quality item very fast delivery",
    "absolutely love the design and quality",
    "this product is worth every penny",
    "I am so glad I chose this product",
    "fantastic item great value excellent",
    "very well made and durable love it",
]
...
neutrals = [
    ...
    "the item is available for next day delivery",
    "I placed the order this morning",
    "the product is sold in packs of three",
    "the warranty covers manufacturing defects",
    "I received the invoice by email",
    "the packaging was standard cardboard box",
    "the product description matches the listing",
    "I have not used it yet",
    "the item is currently under review",
    "I will try it out this weekend",
    "the product is listed under two categories",
    "I read through the reviews before buying",
    "the delivery window is between two and five days",
    "the seller responded to my query",
    "I selected the standard shipping option",
    "the item arrived in its original packaging",
    "the product is eligible for free returns",
    "I created a ticket with customer support",
    "the replacement was sent the next day",
    "I installed the product following the manual",
    "the product comes in small and large sizes",
    "I have ordered from this seller before",
    "the discount was applied at checkout",
    "the product is compatible with my device",
    "I received a confirmation SMS for my order",
    "the item was as described on the website",
    "I processed the return request online",
    "the refund was credited within seven days",
    "the product page shows detailed specifications",
    "I chose the express delivery option",
    "the package was sealed properly on arrival",
    "the order history shows my past purchases",
    "I redeemed my coupon code at checkout",
    "the shipping label was printed correctly",
    "the app shows real time order tracking",
    "I verified my email address after signup",
    "the product is not available in my region yet",
    "I bookmarked the item for later",
    "the size guide helped me choose correctly",
    "I used the comparison tool on the website",
]
...
negatives = [
    ...
    "not good at all very poor",
    "I hate this product it is useless",
    "very bad product do not recommend",
    "completely broken and useless waste",
    "I dislike this it does not work",
    "poor quality and bad customer service",
    "I am not happy with this at all",
    "this product is bad and overpriced",
    "really bad experience very frustrated",
    "the worst product I have seen in years",
    "I would give zero stars if I could",
    "bad product bad packaging bad service",
    "totally useless and a waste of money",
    "I regret this purchase completely",
    "absolutely no value for money at all",
    "this broke after just one use terrible",
    "very disappointed with the quality",
    "the product is defective and unusable",
    "I hate how poorly made this is",
    "not satisfied at all with this item",
    "this is a scam do not buy it",
    "very low quality and overpriced item",
    "the worst decision I made was buying this",
    "I am disgusted by the poor quality",
    "this product is a complete letdown",
    "I dislike this purchase and want a refund",
    "terrible product arrived damaged useless",
    "I am deeply unhappy with this product",
    "bad quality poor design waste of money",
    "completely useless would not buy again",
    "I have had nothing but trouble with this",
    "not worth it bad quality bad service",
    "I am very dissatisfied with this item",
    "awful product poor quality bad experience",
    "this is the most disappointing purchase ever",
    "product is terrible and customer service is worse",
    "I dislike this it broke within days",
    "very poor performance bad quality item",
    "do not waste money on this terrible product",
    "I am unhappy and want my money back",
    "this product failed completely on first use",
]

texts  = positives + neutrals + negatives
labels = [2]*len(positives) + [1]*len(neutrals) + [0]*len(negatives)

print(f"Dataset: {len(positives)} positive, {len(neutrals)} neutral, {len(negatives)} negative")
...
model = LogisticRegression(max_iter=3000, C=3.0, solver="lbfgs")
model.fit(X_train_vec, y_train)

y_pred = model.predict(X_test_vec)
acc = accuracy_score(y_test, y_pred)

# Cross-validation for a more reliable accuracy score
cv_scores = cross_val_score(model, vectorizer.transform(texts), labels, cv=5)
print("=" * 50)
print(f"  Test Accuracy:       {acc * 100:.1f}%")
print(f"  Cross-Val Accuracy:  {np.mean(cv_scores)*100:.1f}% (+/- {np.std(cv_scores)*100:.1f}%)")
print("=" * 50)
...
test_cases = [
    ...
    ("this is amazing",               2),
    ("I dislike this product",        0),
    ("I hate this",                   0),
    ("terrible waste of money",       0),
    ("the package arrived on time",   1),
    ("delivery was on time",          1),
    ("great quality very happy",      2),
    ("not good at all",               0),
    ("bad experience very unhappy",   0),
    ("I really liked it",             2),
    ("works perfectly love it",       2),
]
print("Sanity checks:")
...
for text, expected in test_cases:
    ...
    print(f"  {status} '{text}' → {lmap[pred]}")

print(f"\n{'All checks passed!' if all_pass else 'Some checks failed — model doing its best with limited data.'}")
